...
void TreeCollectionGenerationSystem::PrepareScene()
{
	...
	_DataCollectionSystem->_DirectionalLightEntity.GetPrivateComponent<DirectionalLight>()->m_diffuseBrightness = brightness / 2.0f;
	_DataCollectionSystem->_DirectionalLightEntity.GetPrivateComponent<DirectionalLight>()->m_lightSize = 0.4f;
	_DataCollectionSystem->_DirectionalLightEntity.GetPrivateComponent<DirectionalLight>()->m_bias = 0.1f;
	_DataCollectionSystem->_DirectionalLightEntity1.GetPrivateComponent<DirectionalLight>()->m_diffuseBrightness = 0;
	_DataCollectionSystem->_DirectionalLightEntity2.GetPrivateComponent<DirectionalLight>()->m_diffuseBrightness = 0;
	_DataCollectionSystem->_DirectionalLightEntity3.GetPrivateComponent<DirectionalLight>()->m_diffuseBrightness = brightness / 2.0f;
	_DataCollectionSystem->_DirectionalLightEntity.GetPrivateComponent<DirectionalLight>()->m_diffuse = glm::vec3(1.0f);
	_DataCollectionSystem->_DirectionalLightEntity1.GetPrivateComponent<DirectionalLight>()->m_diffuse = glm::vec3(1.0f);
	_DataCollectionSystem->_DirectionalLightEntity2.GetPrivateComponent<DirectionalLight>()->m_diffuse = glm::vec3(1.0f);
	_DataCollectionSystem->_DirectionalLightEntity3.GetPrivateComponent<DirectionalLight>()->m_diffuse = glm::vec3(1.0f);
	_DataCollectionSystem->_DirectionalLightEntity1.GetPrivateComponent<DirectionalLight>()->m_castShadow = false;
	_DataCollectionSystem->_DirectionalLightEntity2.GetPrivateComponent<DirectionalLight>()->m_castShadow = false;
	_DataCollectionSystem->_DirectionalLightEntity3.GetPrivateComponent<DirectionalLight>()->m_castShadow = false;
